...
public class CustomFees {
    ...
    @Nullable
    private List<FixedFee> fixed_fees;
    @Nullable
    private List<FractionalFee> fractional_fees;
    @Nullable
    private List<RoyaltyFee> royalty_fees;

    public static CustomFees from(List<com.hederahashgraph.api.proto.java.CustomFee> customFees, EntityId tokenId) {
      var customFee = CustomFees.builder()
