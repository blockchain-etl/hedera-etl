...
public class NetworkStake {
  public static NetworkStake from(RecordItem recordItem) {
    ...
    long stakeTotal =
        transactionBody.getNodeStakeList().stream()
    ...
    return builder()
        ...
        .staking_reward_fee_fraction(
            FractionalAmount.from(transactionBody.getStakingRewardFeeFraction()))
  ...
  @Nullable private Long max_stake_rewarded;
  @Nullable private Long max_staking_reward_rate_per_hbar;
  @Nullable private Long max_total_reward;
  @Nullable private FractionalAmount node_reward_fee_fraction;
  @Nullable private Long reserved_staking_rewards;
  @Nullable private Long reward_balance_threshold;
  @Nullable private Long stake_total;
  @Nullable private Long staking_period;
  @Nullable private Long staking_period_duration;
  @Nullable private Long staking_periods_stored;
  @Nullable private FractionalAmount staking_reward_fee_fraction;
  @Nullable private Long staking_reward_rate;
  @Nullable private Long staking_start_threshold;

  @Nullable private Long unreserved_staking_reward_balance;
}
