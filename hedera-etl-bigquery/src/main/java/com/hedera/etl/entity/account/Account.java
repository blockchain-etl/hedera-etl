...
import static com.hedera.etl.recordfile.domain.transaction.RecordFile.HAPI_VERSION_0_27_0;
import static com.hedera.etl.recordfile.utils.DomainUtils.EVM_ADDRESS_LENGTH;
...
public class Account {
  ...
  @Nullable
  private Integer max_automatic_token_associations;

  @Nullable
  private String memo;

  @Nullable
  private Long pending_reward;

  @Nullable
  private Boolean receiver_sig_required;

  @Nullable
  private Long staked_account_id;

  @Nullable
  private Long staked_node_id;

  @Nullable
  private Long stake_period_start;
  ...
  public static Account from(RecordItem recordItem) {
    ...
    if (recordItem.getTransactionBody().hasCryptoUpdateAccount()) {
      ...
      if (transactionBody.hasExpirationTime()) {
        account.setExpiry_timestamp(DomainUtils.timestampInNanosMax(transactionBody.getExpirationTime()));
      }
