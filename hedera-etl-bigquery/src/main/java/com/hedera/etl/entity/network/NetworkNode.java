...
public class NetworkNode {
  ...
  public static Iterable<NetworkNode> from(RecordItem recordItem) {
    if (recordItem.isSuccessful()) {
      if (TransactionType.NODESTAKEUPDATE.getProtoId() == recordItem.getTransactionType()) {
        return fromNodeStakeUpdate(
            recordItem, recordItem.getTransactionBody().getNodeStakeUpdate());
      } else if (TransactionType.NODEUPDATE.getProtoId() == recordItem.getTransactionType()) {
        return fromNodeUpdate(recordItem, recordItem.getTransactionBody().getNodeUpdate());
      }
    }
  ...
  public static Iterable<NetworkNode> fromNodeStakeUpdate(
  ...
  public static Iterable<NetworkNode> fromNodeUpdate(
