...
import com.hedera.etl.reader.recordfile.domain.balance.AccountBalanceFile;
...
public enum StreamType {
  ...
  public static class Extension implements Comparable<Extension> {
    private static final Comparator<Extension> COMPARATOR =
        Comparator.comparing(Extension::getPriority);

    String name;

    @EqualsAndHashCode.Exclude int priority; // starting from 0, larger value means higher priority
