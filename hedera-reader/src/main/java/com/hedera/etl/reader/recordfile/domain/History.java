...
public interface History {
  ...
  default Long getTimestampLower() {
    ...
    return timestampRange != null && timestampRange.hasLowerBound()
        ? timestampRange.lowerEndpoint()
        : null;
  }
  ...
  default Long getTimestampUpper() {
    var timestampRange = getTimestampRange();
    return timestampRange != null && timestampRange.hasUpperBound()
        ? timestampRange.upperEndpoint()
        : null;
  }
