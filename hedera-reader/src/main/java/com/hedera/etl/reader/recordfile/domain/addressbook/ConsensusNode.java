...
package com.hedera.etl.reader.recordfile.domain.addressbook;
...
/**
 * Represents a consensus node while abstracting away the possible different sources of node
 * information.
 */
public interface ConsensusNode extends Comparable<ConsensusNode> {
  ...
  /**
   * The network's current total aggregate stake in tinybars. If staking is not activated, this will
   * be set to the number of nodes in the address book.
   *
