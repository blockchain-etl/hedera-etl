...
public class UpdateDedupeColumnTemplateQuery extends TemplateQuery {
    private static final String QUERY = "UPDATE %s SET dedupe = 1 WHERE UNIX_SECONDS(consensusTimestampTruncated) = %d";
    ...
    TableResult runWith(long consensusTimestampSeconds) throws InterruptedException {
        return runWith(transactionsTable, consensusTimestampSeconds);
    }
}
