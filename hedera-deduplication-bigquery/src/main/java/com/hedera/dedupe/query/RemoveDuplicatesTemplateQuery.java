...
public class RemoveDuplicatesTemplateQuery extends TemplateQuery {
    ...
    public TableResult runWith(long startTimestamp, long endTimestamp) throws InterruptedException {
        return runWith(transactionsTable, transactionsTable, startTimestamp, endTimestamp, startTimestamp, endTimestamp);
    }
}
